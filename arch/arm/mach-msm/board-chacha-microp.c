/* arch/arm/mach-msm/board-chacha-microp.c
...
static struct i2c_client *chacha_microp_client;

static int chacha_microp_function_init(struct i2c_client *client)
{
...
static struct microp_ops ops = {
	.init_microp_func = chacha_microp_function_init,
};
