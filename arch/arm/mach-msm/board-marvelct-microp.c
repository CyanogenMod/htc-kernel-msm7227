/* arch/arm/mach-msm/board-marvelct-microp.c
...
static struct i2c_client *marvelct_microp_client;

static int marvelct_microp_function_init(struct i2c_client *client)
{
...
static struct microp_ops ops = {
	.init_microp_func = marvelct_microp_function_init,
};
