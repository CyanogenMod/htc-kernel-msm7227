/* arch/arm/mach-msm/board-marvelc-microp.c
...
static struct i2c_client *marvelc_microp_client;

static int marvelc_microp_function_init(struct i2c_client *client)
{
...
static struct microp_ops ops = {
	.init_microp_func = marvelc_microp_function_init,
};
