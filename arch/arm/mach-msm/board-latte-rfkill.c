...
static uint32_t latte_bt_init_table[] = {
	PCOM_GPIO_CFG(LATTE_GPIO_UART1_RTS, /* BT_RTS */
			0,
			GPIO_OUTPUT,
			GPIO_NO_PULL,
			GPIO_8MA),
	PCOM_GPIO_CFG(LATTE_GPIO_UART1_CTS, /* BT_CTS */
			0,
			GPIO_INPUT,
			GPIO_NO_PULL,
			GPIO_8MA),
	PCOM_GPIO_CFG(LATTE_GPIO_UART1_RX, /* BT_RX */
			0,
			GPIO_INPUT,
			GPIO_NO_PULL,
			GPIO_8MA),
	PCOM_GPIO_CFG(LATTE_GPIO_UART1_TX, /* BT_TX */
			0,
			GPIO_OUTPUT,
			GPIO_NO_PULL,
			GPIO_8MA),
...
static uint32_t latte_bt_disable_sleep_table[] = {
	PCOM_GPIO_CFG(LATTE_GPIO_UART1_RTS, /* O(L) */
			0,
			GPIO_OUTPUT,
			GPIO_NO_PULL,
			GPIO_8MA),
	PCOM_GPIO_CFG(LATTE_GPIO_UART1_CTS, /* I(PU) */
			0,
			GPIO_INPUT,
			GPIO_PULL_UP,
			GPIO_8MA),
	PCOM_GPIO_CFG(LATTE_GPIO_UART1_RX, /* I(PU) */
			0,
			GPIO_INPUT,
			GPIO_PULL_UP,
			GPIO_8MA),
	PCOM_GPIO_CFG(LATTE_GPIO_UART1_TX, /* O(H) */
			0,
			GPIO_OUTPUT,
			GPIO_NO_PULL,
			GPIO_8MA),
...
void latte_config_bt_disable_sleep(void)
{
	...
	mdelay(5);
	gpio_configure(LATTE_GPIO_UART1_RTS,
			GPIOF_DRIVE_OUTPUT | GPIOF_OUTPUT_LOW);	/* O(L) */
	gpio_configure(LATTE_GPIO_UART1_TX,
