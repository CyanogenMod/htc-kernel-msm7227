/* arch/arm/mach-msm/board-marvel-microp.c
...
static struct i2c_client *marvel_microp_client;

static int marvel_microp_function_init(struct i2c_client *client)
{
...
static struct microp_ops ops = {
	.init_microp_func = marvel_microp_function_init,
};
